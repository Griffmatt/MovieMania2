...
function MovieInfo({id}: Props) {
  ...
  const runTime = (runtime: number) => runtime < 60?`${runtime}m`: `${Math.trunc(runtime/60)}h ${runtime-Math.trunc(runtime/60)*60}m`
        ...
        <div className="movieCardContainer">
              ...
              <div key={movie.title} className="movieCardPoster">
                ...
                <div className="movieInfo">
                    ...
                    <h4>OverView</h4>
                    <p>{movie.overview}</p>
                    <h5>{movieYear}  {runTime(movie.runtime)} <span className='infoRating'>{Math.trunc(movie.vote_average*10)/10}/10</span></h5>   
