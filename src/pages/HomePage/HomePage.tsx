...
function HomePage() {
  ...
  return (
    <>
      {following && (
        <div className="flex">
          <div className=" md:w-2/3 md:border-r-2 md:border-bg-secondary md:dark:border-bg-secondary-dark min-h-[calc(100vh-5.125rem)]">
            <UserFeed following={following.following} userId={userId} />
          </div>
          <div className="sticky top-[4.625rem] lg:top-[5.125rem] md:w-1/3 h-fit p-4 hidden md:block">
